...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    ...
    public partial class AdditionalCacheNodeProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AdditionalCacheNodeProperties"/>. </summary>
        ...
        internal AdditionalCacheNodeProperties(IList<string> cacheNodePropertiesDetailsIssuesList, string aggregatedStatusDetails, string aggregatedStatusText, int? aggregatedStatusCode, string productVersion, bool? isProvisioned, string cacheNodeStateDetailedText, string cacheNodeStateShortText, int? cacheNodeState, IList<CacheNodeDriveConfiguration> driveConfiguration, BgpConfiguration bgpConfiguration, ProxyUrlConfiguration proxyUrlConfiguration, ProxyRequired? isProxyRequired, OSType? osType, CycleType? updateCycleType, string autoUpdateVersion, string updateInfoDetails, DateTimeOffset? updateRequestedOn, string autoUpdateNextAvailableVersion, DateTimeOffset? autoUpdateNextAvailableOn, string autoUpdateAppliedVersion, string autoUpdateLastAppliedDetails, string autoUpdateLastAppliedState, DateTimeOffset? autoUpdateLastAppliedOn, DateTimeOffset? autoUpdateLastTriggeredOn, int? creationMethod, string optionalProperty1, string optionalProperty2, string optionalProperty3, string optionalProperty4, string optionalProperty5, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        internal BgpConfiguration BgpConfiguration { get; set; }
        ...
        internal ProxyUrlConfiguration ProxyUrlConfiguration { get; set; }
