...
namespace Azure.ResourceManager.ConnectedCache.Models
{
    public partial class AdditionalCacheNodeProperties : IUtf8JsonSerializable, IJsonModel<AdditionalCacheNodeProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UpdateCycleType))
            {
                writer.WritePropertyName("updateCycleType"u8);
                writer.WriteStringValue(UpdateCycleType.Value.ToString());
            }
        ...
        internal static AdditionalCacheNodeProperties DeserializeAdditionalCacheNodeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CycleType? updateCycleType = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("updateCycleType"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    updateCycleType = new CycleType(property.Value.GetString());
                    continue;
                }
