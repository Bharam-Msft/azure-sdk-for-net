...
{
    public partial class AdditionalCustomerProperties : IUtf8JsonSerializable, IJsonModel<AdditionalCustomerProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalCustomerProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AdditionalCustomerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCustomerProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdditionalCustomerProperties)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsDefined(PeeringDbLastUpdateDateValue))
            {
                writer.WritePropertyName("peeringDbLastUpdateDate"u8);
                writer.WriteStringValue(PeeringDbLastUpdateDateValue.Value, "O");
            }
            ...
            if (Optional.IsDefined(CustomerEntitlementExpiration))
            {
                writer.WritePropertyName("customerEntitlementExpiration"u8);
                writer.WriteStringValue(CustomerEntitlementExpiration.Value, "O");
            }
        ...
        AdditionalCustomerProperties IJsonModel<AdditionalCustomerProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCustomerProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdditionalCustomerProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAdditionalCustomerProperties(document.RootElement, options);
        }

        internal static AdditionalCustomerProperties DeserializeAdditionalCustomerProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AdditionalCustomerProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCustomerProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdditionalCustomerProperties)} does not support writing '{options.Format}' format.");
            }
        }

        AdditionalCustomerProperties IPersistableModel<AdditionalCustomerProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdditionalCustomerProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdditionalCustomerProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<AdditionalCustomerProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
